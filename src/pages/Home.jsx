        ...
        <div class="flex w-full justify-center py-10">
            <div class="flex flex-col place-items-center">
                ...
                <div class="mt-20 flex flex-col gap-14 md:flex-row">
                    <Link class="flex justify-center" to="basic_tutorials/connect_wallets"><div class="flex h-10 cursor-pointer items-center justify-center rounded-full bg-[#733dff] px-10 py-1 text-base font-semibold  hover:opacity-90 text-[#EEE] md:text-xl">Get Started</div></Link>
